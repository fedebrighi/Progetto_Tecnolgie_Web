<main class="bg-dark text-light">
    ...
    <div class="container py-5">
        <div class="text-center mb-4">
            ...
            <p class="text-light fs-5">Visualizza le notifiche ricevute e gestiscile facilmente.</p>
        </div>
        ...
        <?php if (empty($templateParams["notifiche"])): ?>
            ...
            <div class="text-center my-5">
                ...
                <p class="fs-4 text-light">Torna più tardi per verificare se ci sono aggiornamenti.</p>
            </div>
        <?php else: ?>
            <!-- Elenco Notifiche -->
            <div class="row gy-3">
                <?php foreach ($templateParams["notifiche"] as $notifica): ?>
                    <div class="col-12 d-flex align-items-center border-bottom border-secondary pb-3"
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="m-0 text-light">Messaggio: <?php echo $notifica['messaggio']; ?></p>
