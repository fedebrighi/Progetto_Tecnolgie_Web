<main>
    <div class="container py-4">
        <div class="text-center mb-4">
            ...
            <h1 class="text-warning">Ordine # <?php echo $order["codiceOrdine"]; ?> </h1>
        ...
        <div class="border border-secondary rounded p-4 mb-5">
            ...
            <div class="text-center">
                <h3 class="text-warning mb-3"><strong> Totale: <?php echo $order["totale"]; ?> €</strong></h3>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-dark">
                <div class="modal-header">
                    <h3 class="modal-title" id="trackingModalLabel-<?php echo $order['codiceOrdine']; ?>">Stato
                        dell'Ordine #<?php echo $order['codiceOrdine']; ?></h3>
            ...
            ?>
                <div
                    ...
                    <div style="flex-grow: 1;">
                        <h3 style="margin: 0; font-size: 1.25rem;"><?php echo $birra["nome"] ?></h3>
