<main>
    <div class="container py-4">
        <div class="text-center mb-4">
            <h1 class="text-warning">Benvenuto!</h1>
        ...
        <div class="row gy-4">
            <div class="col-md-6">
                <div class="border border-secondary rounded p-4 bg-dark">
                    <h2 class="text-warning mb-3">Gestione Prodotti</h2>
            ...
            <div class="col-md-6">
                <div class="border border-secondary rounded p-4 bg-dark">
                    <h2 class="text-warning mb-3">Monitoraggio Vendite</h2>
        ...
        <div class="row gy-4 mt-4">
            <div class="col-md-12">
                <div class="border border-secondary rounded p-4 bg-dark">
                    <h2 class="text-warning mb-3">Storico Ordini</h2>
